...
class SoupDishServiceTest {
    ...
    fun setUp() {
        ...
        soupDishService = Retrofit.Builder()
            .baseUrl(mockWebServer.url(""))
            .addConverterFactory(GsonConverterFactory.create())
            .build()
            .create(SoupDishService::class.java)
    }

    @ExperimentalCoroutinesApi
    @Test
    fun getSoupDishesTest() {
        runTest {
            val jsonResponse =
            ...
            val actual = soupDishService.getSoupDishes()
